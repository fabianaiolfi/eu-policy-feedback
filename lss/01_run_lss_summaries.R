...
all_dir_reg <- corpus(all_dir_reg_summaries,
                      docid_field = "CELEX",
                      text_field = "eurlex_summary_clean",
                      meta = "test_id")
...
saveRDS(glove_polarity_scores, file = here("data", "lss", "glove_polarity_scores_summaries_econ.rds"))
