...
*Note: Using the full dataset (ca. 70k observations) showed almost identical results. Also using a larger GloVe model, e.g. 300 dimensions, doesn’t alter results in a way that justify the longer computational time.*
